    ...
    <body>
        ...
        <div class="col-2">
            <div class="imagem">
                <img src="https://ifc.edu.br/wp-content/uploads/2022/12/Logo_IFC_vertical-1.png" width="130px" alt="ifc" srcset="">
                <br>
            </div>
        </div>
            <div class="col-5">
...
<input type="password" class="form-control" value="<?php if ($acao == 'editar') echo ""; ?>" name="confirmarSenha" id="confirmarSenha" placeholder="Comfirmar Senha:"> <br>
        ...
        <!--BOTÃO DE CANCELAR-->
            <button class="btn btn-outline-success" onclick="window.location.href='../index.php'">Cancelar</button>
